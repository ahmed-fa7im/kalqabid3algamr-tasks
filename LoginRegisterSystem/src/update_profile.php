...
if (isset($_POST['update_profile'])) {
    ...
    mysqli_query($link, "UPDATE `user_form` SET name = '$update_name'
    , email = '$update_email'") or die('query failed');
    ...
    if (!empty($update_pass) || !empty($new_pass) || !empty($confirm_pass))
        if ($update_pass != $old_pass) {
            ...
            mysqli_query($link, "UPDATE `user_form` SET password = '$confirm_pass' 
    ...
    if (!empty($update_image)) {
        if ($update_image_size > 2000000) {
            ...
            $image_update_query = mysqli_query(
                $link,
                "UPDATE `user_form` SET image = '$update_image' WHERE id = '$user_id'"
            )
                or die('query failed');
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="flex">
                <div class="inputBox">
                    ...
                    <input type="file" name="update_image" class="box" accept="update_image/jpeg, update_image/jpg, update_image/png">
                </div>
                <div class="inputBox">
            ...
            <a href="home.php" id="delete-btn">go back</a>
